...
cp -rp linux.x86_64/rel/*.so linux.x86_64/rel/xsvf2csvf ${LIB}-${DATE}/linux.x86_64/rel/
mkdir -p ${LIB}-${DATE}/linux.x86_64/dbg
cp -rp linux.x86_64/dbg/*.so ${LIB}-${DATE}/linux.x86_64/dbg/

# Linux i686 binaries
mkdir -p ${LIB}-${DATE}/linux.i686/rel
cp -rp linux.i686/rel/*.so linux.i686/rel/xsvf2csvf ${LIB}-${DATE}/linux.i686/rel/
